...
const defaultContent = {
    ...
    selectedWork: [
        { id: 1, title: "Modern Aesthetics", category: "Branding / Web Design", image: "" },
        { id: 2, title: "Elevated Living", category: "Social Media / Content", image: "" }
    ],
    testimonials: [
        { id: 1, text: "Bloom Branding completely transformed our digital presence. The team is incredible!", author: "Jane Doe, CEO", rating: 5 },
        { id: 2, text: "Creative, professional, and results-driven. Highly recommend!", author: "John Smith, Founder", rating: 5 },
        { id: 3, text: "They truly understood our vision and brought it to life.", author: "Sarah Lee, CMO", rating: 5 }
    ],
    instagram: [
        { id: 1, image: "", link: "#" },
        { id: 2, image: "", link: "#" },
